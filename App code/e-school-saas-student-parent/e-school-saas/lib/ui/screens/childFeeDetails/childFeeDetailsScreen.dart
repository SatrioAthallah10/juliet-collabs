...
class _ChildFeeDetailsScreenState extends State<ChildFeeDetailsScreen> {
  ...
  void prePaymentTasksListener(
    ...
    _paymentGatewayService?.handlePrePaymentTasksListener(
      state: state,
      paymentMethodGetter: (state) => (state as PrePaymentTasksSuccess).paymentMethod.paymentMethod ?? "",
      apiKeyGetter: (state) => (state as PrePaymentTasksSuccess).paymentMethod.apiKey ?? "",
      errorMessageGetter: (state) => (state as PrePaymentTasksFailure).errorMessage,
