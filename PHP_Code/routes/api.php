...
Route::post('/apiadmin/subscription/activate', [PaymentApiController::class , 'activateAfterPayment']);
Route::post('/check-activation', [PaymentApiController::class , 'checkActivation']);
Route::post('/webhook/doku', [PaymentApiController::class , 'dokuWebhook'])
    ->middleware([\App\Http\Middleware\LogDokuWebhook::class])
    ->withoutMiddleware([
...
Route::post('external-api/students/store', [\App\Http\Controllers\Api\ExternalApiController::class , 'storeStudent']);
