...
Route::get('schools/register', function () {
    $packages = \App\Models\Package::where('status', 1)->orderBy('rank', 'ASC')->get();
    $settings = app(\App\Services\CachingService::class)->getSystemSettings();
    return view('schools.register', compact('packages', 'settings'));
});

Route::get('register', function () {
    $packages = \App\Models\Package::where('status', 1)->orderBy('rank', 'ASC')->get();
    $settings = app(\App\Services\CachingService::class)->getSystemSettings();
    $extraFields = app(\App\Services\CachingService::class)->getSchoolExtraFields();
    return view('registration_form', compact('packages', 'settings', 'extraFields'));
})->name('register');
...
// Chatbot complaint submission (public, rate-limited)
Route::post('chatbot/complaint', [ComplaintController::class , 'store'])
    ->middleware('throttle:5,1')
    ->name('chatbot.complaint.store');
...
Route::group(['prefix' => 'school'], static function () {
    ...
    // [SETTINGS_FEATURE_DISABLED] Route::get('refund-cancellation-policy', [Controller::class , 'refund_cancellation']);
...
Route::group(['middleware' => ['Role', 'checkSchoolStatus', 'status', 'SwitchDatabase', 'verifiedEmail', 'CheckForMaintenanceMode', '2fa', 'wizardSettings']], static function () {
    ...
    Route::group(['middleware' => 'language'], static function () {
            ...
            Route::group(['prefix' => 'schools/custom-field'], static function () {
                    Route::get('/', [FormFieldsController::class , 'schoolIndex'])->name('schools.custom-field.index');
                    Route::post('/store', [FormFieldsController::class , 'schoolStore'])->name('schools.custom-field.store');
                    Route::put('/{id}', [FormFieldsController::class , 'schoolUpdate'])->name('schools.custom-field.update');
                    Route::get('/list', [FormFieldsController::class , 'schoolShow'])->name('schools.custom-field.list');
                    Route::delete('/delete/{id}', [FormFieldsController::class , 'schoolDestroy'])->name('schools.custom-field.destroy');
                    Route::post('/update-rank', [FormFieldsController::class , 'schoolUpdateRankOfFields']);
                    Route::put("/{id}/restore", [FormFieldsController::class , 'schoolRestore'])->name('schools.custom-field.restore');
                    Route::delete("/{id}/deleted", [FormFieldsController::class , 'schoolTrash'])->name('schools.custom-field.trash');
                }
                );
                ...
                Route::group(['prefix' => 'schools'], static function () {
                    ...
                    Route::get('/inquiry', [SchoolController::class , 'schoolInquiryIndex'])->name('inquiry.index');
                    Route::get('/inquiry/list', [SchoolController::class , 'schoolInquiryList'])->name('inquiry.list');
                    Route::post('/inquiry/update', [SchoolController::class , 'schoolInquiryUpdate'])->name('inquiry.update');
                    Route::delete('/inquiry/{id}/delete', [SchoolController::class , 'schoolInquiryDelete'])->name('inquiry.delete');
                ...
                Route::group(['prefix' => 'system-settings'], static function () {
                    ...
                    // [SETTINGS_FEATURE_DISABLED] Route::get('third-party-apis', [SystemSettingsController::class , 'thirdPartyApiIndex'])->name('system-settings.third-party');
                    // [SETTINGS_FEATURE_DISABLED] Route::post('third-party-apis', [SystemSettingsController::class , 'thirdPartyApiUpdate'])->name('system-settings.third-party.update');
                    ...
                    // [SETTINGS_FEATURE_DISABLED] Route::get('refund-cancellation', [SystemSettingsController::class , 'refund_cancellation'])->name('system-settings.refund-cancellation');
                ...
                Route::group(['prefix' => 'complaints'], static function () {
                    ...
                    Route::get('/list', [ComplaintController::class , 'show'])->name('complaints.show');
                    Route::put('/update-status/{id}', [ComplaintController::class , 'updateStatus'])->name('complaints.update-status');
                    Route::delete('/trash/{id}', [ComplaintController::class , 'trash'])->name('complaints.trash');
                    Route::put('/restore/{id}', [ComplaintController::class , 'restore'])->name('complaints.restore');
                    Route::delete('/destroy/{id}', [ComplaintController::class , 'destroy'])->name('complaints.destroy');
                }
                );
                ...
                // [SUPPORT_MODULE_DISABLED] Route::get('staff/support', [StaffController::class , 'support']);
         ...
         // Route::post('/', [AssignElectiveSubjectController::class, 'store'])->name('assign.elective.subject.store');
                ...
                Route::group(['prefix' => 'school-settings'], static function () {
                    ...
                    Route::get('contact-us', [SchoolSettingsController::class , 'contact_us'])->name('school-settings.contact-us');
                    Route::get('about-us', [SchoolSettingsController::class , 'about_us'])->name('school-settings.about-us');
                ...
                // [SETTINGS_FEATURE_DISABLED] Route::get('refund-cancellation', [SchoolSettingsController::class , 'refund_cancellation'])->name('school-settings.refund-cancellation');
        
                // [SETTINGS_FEATURE_DISABLED] Route::get('third-party-apis', [SchoolSettingsController::class , 'thirdPartyApiIndex'])->name('school-settings.third-party');
                // [SETTINGS_FEATURE_DISABLED] Route::post('third-party-apis', [SchoolSettingsController::class , 'thirdPartyApiUpdate'])->name('school-settings.third-party.update');
                }
                );
                ...
                // Student Reports
                Route::get('reports/student', [ReportsController::class , 'student_reports'])->name('reports.student.student-reports');
                ...
                Route::get('reports/teacher', [ReportsController::class , 'teacher_reports'])->name('reports.teacher.teacher-reports');
                ...
                Route::group(['prefix' => 'reports/exam'], static function () {
                    ...
                    Route::get('rank-wise-result/{student_id}/{session_year_id}', [ReportsController::class , 'rankWiseResultPdf'])->name('reports.exam.rank-wise-result-pdf');
...
Route::prefix('payment')->group(function () {
    ...
    Route::get('/success', [\App\Http\Controllers\Api\PaymentApiController::class , 'success'])->name('payment.success');
});



// Super admin Privacy Policy
...
// Super admin Teacher Staff Privacy Policy
...
// Super Admin Student Parent Privacy Policy
...
// Super Admin Student Terms & Conditions
...
// Super Admin Teacher Terms & Conditions
...
// [SETTINGS_FEATURE_DISABLED] Super Admin Refund Cancellation
...
// Super Admin School Terms & Conditions
...
// [SETTINGS_FEATURE_DISABLED] Route::get('school-settings/{id}/refund-cancellation', [SchoolSettingsController::class , 'public_refund_cancellation'])->name('school-settings.get-refund-cancellation');
Route::get('school-settings/{id}/contact-us', [SchoolSettingsController::class , 'public_contact_us'])->name('school-settings.get-contact-us');
Route::get('school-settings/{id}/about-us', [SchoolSettingsController::class , 'public_about_us'])->name('school-settings.get-about-us');
...
Route::get('/verify/{id}', [SchoolController::class , 'verifyPage'])->name('verify.page');



Route::match (['get', 'post'], '/registration/cancel/{id}', function ($id) {
    $inquiry = \App\Models\SchoolInquiry::find($id);

    if (!$inquiry) {
        return redirect('/')->with('error', 'Data registrasi tidak ditemukan.');
    }

    // Hapus data terkait (extra school details)
    $inquiry->extra_school_details()->delete();
