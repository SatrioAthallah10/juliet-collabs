...
<div class="border border-secondary rounded-lg my-4 mx-1">
    ...
    <div class="row my-4 mx-1">
        ...
        <div class="form-group col-md-6 col-lg-6 col-xl-4 col-sm-12">
            <label for="login_page_logo">{{ __('login_page_logo') }} <span class="text-danger">*</span> <small class="text-muted">(200x200 pixels)</small></label>
            <input type="file" name="login_page_logo" id="login-page-logo-input" class="file-upload-default" accept="image/*"/>
            <div class="input-group col-xs-12">
        ...
        {{-- <div class="form-group col-md-6 col-lg-6 col-xl-4 col-sm-12">
            <label for="student_web_background_image">{{ __('student_web_background_image') }} <span class="text-danger">*</span> <small class="text-muted">(Recommended size: 1920x1080 pixels)</small></label>
            <input type="file" name="student_web_background_image" id="student-web-background-image-input" class="file-upload-default" accept="image/*"/>
            <div class="input-group col-xs-12">
                <input type="text" class="form-control file-upload-info" id="student_web_background_image" disabled="" placeholder="{{ __('student_web_background_image') }}" />
                <span class="input-group-append">
                    <button class="file-upload-browse btn btn-theme" type="button">{{ __('upload') }}</button>
                </span>
                <div class="col-md-12 mt-2">
                    <img height="100px" width="100px" src='{{ !empty($settings['student_web_background_image']) ? url($settings['student_web_background_image']) : asset('assets/no_image_available.jpg') }}' alt="Student Web Background Image" class="">
                </div>
            </div>
        </div> --}}
        ...
        {{-- <div class="form-group col-md-4 col-sm-12">
            ...
            <input name="student_web_url" id="student_web_url" value="{{ $settings['student_web_url'] ?? '' }}" type="text" required placeholder="{{ __('student_web_url') }}" class="form-control"/>
        </div> --}}
    </div>
</div>
{{-- End System Settings --}}
